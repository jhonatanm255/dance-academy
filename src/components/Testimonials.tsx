...
import { collection, getDocs, addDoc } from "firebase/firestore";
import Swal from "sweetalert2";
import Modal from "../components/ModalTestimonial"; // Importa el componente Modal
...
export default function Testimonials() {
  ...
  // Abre el modal si el usuario está autenticado
  useEffect(() => {
    if (user) {
      setIsModalOpen(true); // Abre el modal automáticamente después de iniciar sesión
    }
  }, [user]);
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-2xl mx-auto mt-12 text-center">
          <button
            onClick={signIn} // Abre el pop-up de inicio de sesión con Google
            className="bg-white text-gray-600 px-6 py-3 rounded-lg shadow-lg hover:shadow-xl transition-shadow flex items-center mx-auto"
          >
            <img
              src="https://www.google.com/favicon.ico"
